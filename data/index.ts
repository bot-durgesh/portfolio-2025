...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a AI trip planner.",
...
export const projects = [
  {
    ...
    des: "Developed a responsive AI-powered content management system, automating content creation and integrating secure authentication, analytics, and optimized media delivery.",
    img: "/creatr.png",
    iconLists: ["/next.svg", "/re.svg", "/ts.svg", "/tail.svg", "/fm.svg"],
    link: "https://creatr-one.vercel.app/",
  },
  {
    id: 2,
...
export const workExperience = [
  ...
  },
  {
    id: 4,
    title: "CP Lead",
    desc: "CP Lead mentoring peers through problem-solving sessions, sharing curated resources, and writing articles to simplify complex data structure concepts.",
    className: "md:col-span-2",
    thumbnail: "/serverx.png",
  },
];
...
export const socialMedia = [
  {
    id: 1,
    img: "/git.svg",
    link:'https://github.com/bot-durgesh'
  },
  {
    id: 2,
    img: "/twit.svg",
  ...
  },
  {
    id: 3,
    img: "/link.svg",
    link:'https://www.linkedin.com/in/ankoji-durgesh'
  },
];